...
if b"root" in userInfo["ID"]["results"][0]:
...
if b"debian" in sysInfo["KERNEL"]["results"][0] or b"ubuntu" in sysInfo["KERNEL"]["results"][0]:
...
version = sysInfo["KERNEL"]["results"][0].decode().split(" ")[2].split("-")[0]
